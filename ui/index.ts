import {
  ...
  public button4: CustomDialogButton
	...
	constructor(defaultPortrait?: ImageData, useDarkTheme?: boolean|Texture, sound?: string) {
	  ...
	  this.uiTheme = ( useDarkTheme instanceof Texture )? useDarkTheme : useDarkTheme == true ? darkTheme : lightTheme
	  ...
	  if(sound){
		  ...
		  this.soundEnt.addComponent(
			  new AudioSource(new AudioClip(sound))
		  )
	  ...
	  this.button1 = new CustomDialogButton(this.container, this.uiTheme,
	  "yes", button1XPos, button1YPos,  () =>{
	  ...
	  this.button2 = new CustomDialogButton(this.container, this.uiTheme,
	  "no", button2XPos, button2YPos,  () =>{
	  ...
	  this.button3 = new CustomDialogButton(this.container, this.uiTheme,
	  "maybe", button3XPos, button3YPos,  () =>{
	  ...
	  this.button4 = new CustomDialogButton(this.container, this.uiTheme,
	  "maybe", button4XPos, button4YPos,  () =>{
	...
	public openDialogWindow(NPCScript: Dialog[], textId: number): void {
	  ...
	  DialogTypeInSystem._instance.newText(this.text, currentText.text, currentText.typeSpeed? currentText.typeSpeed: null)
	  ...
	  if (!this.ClickAction) {
		...
		this.EButtonAction = Input.instance.subscribe(
		  ...
		  false,
		  (e) => {
			if (this.isDialogOpen && this.isQuestionPanel && DialogTypeInSystem._instance.done && +Date.now() - this.UIOpenTime > 100) {
	  ...
	  if (currentText.isQuestion) {
			  ...
			  if(currentText.buttons.length >=1){
				  this.button1.update(
					  ...
					  currentText.buttons[0].offsetX? currentText.buttons[0].offsetX + button1XPos: button1XPos,
					  currentText.buttons.length >=3? currentText.buttons[0].offsetY?  currentText.buttons[0].offsetY + button1YPos4: button1YPos4 :
					  currentText.buttons[0].offsetY?  currentText.buttons[0].offsetY + button1YPos: button1YPos
				  )
			  }
			  ...
			  if(currentText.buttons.length >=2){
				  this.button2.update(
					  ...
					  currentText.buttons[1].offsetX? currentText.buttons[1].offsetX + button2XPos: button2XPos,
					  currentText.buttons.length >=3? currentText.buttons[1].offsetY?  currentText.buttons[1].offsetY + button2YPos4: button2YPos4 :
					  currentText.buttons[1].offsetY?  currentText.buttons[1].offsetY + button2YPos: button2YPos
				  )
			  }
			  ...
			  if(currentText.buttons.length >=3){
				  this.button3.update(
					  ...
					  currentText.buttons[2].offsetX? currentText.buttons[2].offsetX + button3XPos: button3XPos,
					  currentText.buttons[2].offsetY?  currentText.buttons[2].offsetY + button3YPos: button3YPos	
				  )
			  }
			  ...
			  if(currentText.buttons.length >=4){
				  this.button4.update(
					  ...
					  currentText.buttons[3].offsetX? currentText.buttons[3].offsetX + button4XPos: button4XPos,
					  currentText.buttons[3].offsetY?  currentText.buttons[3].offsetY + button4YPos: button4YPos	
				  )
			  }
